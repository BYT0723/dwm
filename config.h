...
static const          int bar24bit     = 0;   /* 1 = 24-bit opaque flat bar with the systray merged in; 0 = 32-bit ARGB bar + separate systray window */
...
static const          int showtitleicon   = 1;   /* 1 = draw the client icon at the left of the titlebar, 0 = text only */
static const          int titlebaralign   = 1;   /* text alignment, icon stays left: 0 = left, 1 = center (true center of full width), 2 = right */
